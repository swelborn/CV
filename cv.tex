...
\begin{itemize}
  \item Streaming from the National Center for Electron Microscopy (\href{https://foundry.lbl.gov/about/facilities/the-national-center-for-electron-microscopy-ncem/}{NCEM}) to NERSC
    \begin{itemize}
      ...
      \item Implemented \textit{\href{https://zeromq.org/}{ZeroMQ}}-based pipeline to stream data over 100 GbE directly to Perlmutter compute nodes, boosting raw throughput by \textbf{5--14x}.
      ...
      \item Developing a flow-based programming application for interactive streaming: \href{https://github.com/NERSC/interactEM}{interactEM}.
    \end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Technologies used:} ZeroMQ, NATS, git, pvaPy, CMake, vcpkg, pydantic, MessagePack, React, Redux, FastAPI, PostgreSQL, Alembic, Kubernetes, Helm, Helmfile, Docker, podman, GitHub Actions, slurm, Spin (NERSC Kubernetes cluster), Dask, ipywidgets, Superfacility API
...
\begin{itemize}
  \item Summer 2025: Planned mentorship of three NERSC interns for work on \href{https://github.com/NERSC/interactEM}{interactEM}
